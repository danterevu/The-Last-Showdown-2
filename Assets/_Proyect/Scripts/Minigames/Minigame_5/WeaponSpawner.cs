...
/// Spawnea pickups de armas en los puntos de cada zona activa.
/// SpaceMinigame llama SetActiveZone() al cambiar de zona,
/// igual que KingOfHill hacía con PowerUpSpawner.

/// SETUP:
///   - Arrastrar los WeaponData de cada arma al array weaponPool
///   - Configurar zones con los puntos de spawn por zona (
///   - weaponPickupPrefab: prefab base con WeaponPickup.cs 
...
public class WeaponSpawner : MonoBehaviour
{
    ...
    [SerializeField] private float spawnInterval = 12f;  // segundos entre spawns
