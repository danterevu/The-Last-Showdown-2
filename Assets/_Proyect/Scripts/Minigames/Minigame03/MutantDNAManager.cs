...
public class MutantDNAManager : MonoBehaviour, IMinijuegoControlable
{
    ...
    private int GetNextZone(int currentZone)
    {
        ...
        // Remover la zona actual si est� en la lista (para no repetirla)
    ...
    private IEnumerator PlayZoneTransition(int oldZoneIndex, int newZoneIndex)
    {
        ...
        // Mover c�mara si tienes ZoneCameraController, si no, opcional
    ...
    private void ActivateDNAZone(int index, bool teleportImmediately = false)
    {
        ...
        // Respawnea el ADN (opcional, puedes elegir no respawnearlo aqu�)
        dnaPickup.SpawnDNA();
        // Si tienes cajas est�ticas, tambi�n puedes reposicionarlas seg�n la zona
