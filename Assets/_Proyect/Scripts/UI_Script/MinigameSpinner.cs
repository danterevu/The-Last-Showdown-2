...
{
    [Header("Configuraci�n de Minijuegos")]
    ...
    // Offset centralizado � cambi� solo este valor si ajust�s la ruleta
    ...
    private int GetWinnerIdFromAngle(float rawAngle)
    {
        ...
        Debug.Log($"=== DEBUG RULETA ===\nRaw Angle: {rawAngle:F1}°\nANGLE_OFFSET: {ANGLE_OFFSET}°\nNormalized Angle: {normalizedAngle:F1}°\nDegrees per slice: {degreesPerSlice}°\nSection Index: {sectionIndex}\nWinner ID: {sectionIndex + 1}");
